  ...
  return (
    <>
      <div className="flex gap-2 mt-40 bg-amber-50">
        <div className="m-15">
          <button className="text-xs font-sans-serif bg-amber-100 w-30 p-1 text-orange-600 shadow-lg shadow-white/30 rounded-xl">
            NEW COLLECTION
          </button>
          <div className="font-italic">
            ...
            <p className="mt-4 text-gray-600">
              Discover our latest arrivals, designed to elevate your everyday
              look with a blend of comfort and style.
            </p>
          </div>
          <div className="flex gap-5">
            <div className="flex justify-center items-center gap-5 w-50 cursor-pointer bg-orange-600 text-white mt-6 p-2 rounded-lg shadow-[0px_8px_15px_-5px_rgba(0,0,0,0.2)]" onClick={()=>{navigate("/Shop")}}>
              <span>Shop Collection</span>
              <span>
                <MdArrowForward />
              </span>
            </div>
            <div className="flex items-center justify-center bg-white shadow-lg border border-gray-300 w-40 mt-6 p-2 rounded-lg cursor-pointer">
              Featured Items
            </div>
          </div>

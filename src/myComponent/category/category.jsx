      ...
      <div className=" mt-10">
        ...
        <div className="flex flex-wrap gap-8 ml-18 mt-4 mb-20">
          <Catogo
            ...
            title="Clothes"
            count="2"
            onClick={(e) => handleProductValue("Clothes", "Clothing")}
          />
          <Catogo
            image={Accessor}
            title="Accessories"
            count="5"
            onClick={(e) => handleProductValue("Accessories", "Accessories")}
          />
          <Catogo
            image={Footware}
            title="Shoes"
            count="4"
            onClick={(e) => handleProductValue("Shoes", "Footwear")}
          />
          <Catogo
            image={Home}
            ...
            count="3"
            onClick={(e) =>
              handleProductValue("Home appliances", "Home & Living")
            }
          />
        </div>
      </div>
